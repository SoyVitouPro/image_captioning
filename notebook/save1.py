...
for epoch in range(num_epochs):
    ...
    if wer < best_wer:
        ...
        torch.save(encoder.state_dict(), 'encoder_finalv1_att_final_deit.pth')
        torch.save(decoder.state_dict(), 'decoder_finalv1_att_final_deit.pth')
...
plt.tight_layout()
plt.savefig("training_evaluation_metrics_deit.png", dpi=300)
plt.show()
