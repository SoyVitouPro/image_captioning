...
for epoch in range(num_epochs):
    ...
    if bleu4 > best_bleu4:
        best_bleu4 = bleu4
        epochs_no_improve = 0
        torch.save(encoder.state_dict(), 'encoder_final_v1.pth')
        torch.save(decoder.state_dict(), 'decoder_final_v1.pth')
    else:
        epochs_no_improve += 1
...
plt.tight_layout()
plt.savefig("training_evaluation_metrics_finalv1.png", dpi=300)
plt.show()
